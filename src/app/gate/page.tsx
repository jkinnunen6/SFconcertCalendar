    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .gate-left::before { content: ''; position: absolute; top: -20%; left: -20%; width: 60%; height: 60%; background: radial-gradient(circle, rgba(0,170,255,0.05) 0%, transparent 70%); pointer-events: none; }
        .wordmark { display: flex; flex-direction: column; line-height: 0.9; letter-spacing: 0.02em; }
        .wordmark-bay { font-family: 'Bebas Neue', sans-serif; font-size: clamp(4rem, 8vw, 7rem); color: #00AAFF; }
        ...
        .gate-label { font-size: 0.65rem; letter-spacing: 0.2em; color: #777; text-transform: uppercase; margin-bottom: 1.5rem; }
        .gate-form { display: flex; flex-direction: column; gap: 1rem; max-width: 320px; }
        .gate-input { width: 100%; background: transparent; border: none; border-bottom: 1px solid #333; padding: 0.75rem 0; font-family: 'DM Serif Display', serif; font-size: 1.4rem; color: #f0ece4; outline: none; transition: border-color 0.2s; letter-spacing: 0.1em; }
        .gate-input::placeholder { color: #555; font-style: italic; }
        .gate-input:focus { border-bottom-color: #00AAFF; }
        ...
        .gate-submit { margin-top: 0.5rem; background: none; border: 1px solid #444; color: #aaa; font-family: 'DM Sans', sans-serif; font-size: 0.7rem; letter-spacing: 0.15em; text-transform: uppercase; padding: 0.75rem 1.5rem; cursor: pointer; transition: all 0.2s; align-self: flex-start; }
        .gate-submit:hover:not(:disabled) { border-color: #00AAFF; color: #00AAFF; }
